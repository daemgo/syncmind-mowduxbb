...
import { ArrowLeft, Phone, MapPin, User, Calendar, DollarSign } from "lucide-react";
    ...
    <div className="space-y-6 p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <Badge className={getBadgeClassName(item.status)}>
          {getDictLabel("dict-sales-order-status", item.status)}
        </Badge>
      </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-muted/50 font-medium">
                      <td colSpan={3} className="px-4 py-3 text-right">合计</td>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="rounded-lg bg-muted/50 p-4 text-center">
                  <p className="text-sm text-muted-foreground mb-1">已收款</p>
                  <p className="text-2xl font-bold text-emerald-600">¥{item.paidAmount.toLocaleString()}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-4 text-center">
                  <p className="text-sm text-muted-foreground mb-1">应收款</p>
